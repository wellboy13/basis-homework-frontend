...
console.log(numbers) // выводим массив в консоль

const numbers_squared = [] // создаем пустой массив

for(let i = 0; i < numbers.length; i++) { 
    numbers_squared.push(numbers[i] ** 2)
} // запускаем цикл для заполнения новго массива числами в **2
...
let last_elem = numbers_squared[6] //получаем значение последней ячейки массива numbers_squared
// или...
//let last_elem = numbers_squared.pop() //удалит и вернет последний элемент массива переменной let last_elem
